...
import { PoPageDynamicTableActions, PoPageDynamicTableFilters } from '@po-ui/ng-templates';
...
export class TurmasListComponent implements OnInit{
    ...
    public readonly fields: Array<any> = [
        {property: 'descricao', label: 'Descrição', filter: true , gridColumns: 6, width: '30%'},
        ...
        {property: 'status',type: 'label', optionsMulti: true, filter: true, gridColumns: 5,
            options: [
                ...
                labels: [{ value: 'aberta', color: 'color-05', content: 'A', label: 'Aberto' },
                { value: 'fechado', color: 'color-02', content: 'F', label: 'Fechado' },
                { value: 'limiteDeVagas', color: 'color-08', content: 'VP', label: 'Vagas preenchidas'}
            ]        
        }
    ]
