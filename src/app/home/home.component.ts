...
import { PoPageAction, PoModalComponent, PoBreadcrumb, PoNotificationService, PoModalAction } from '@po-ui/ng-components';
...
export class HomeComponent {
    ...
    public readonly actions: Array<PoPageAction> = [
        { label: 'Help', action: this.modalOpen.bind(this), icon: 'po-icon po-icon-help' }
      ];
      ...
      help() {
        if (this.formHelp.valid) {
          this.poNotification.success(`To get help please acess our help ${this.page}.`);
        } else {
